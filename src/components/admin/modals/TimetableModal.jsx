// src/components/admin/TimetableModal.jsx
        ...
        <div className="modal timetable-modal" onClick={(e) => e.stopPropagation()}>
          ...
          <div className="modal-body">
            <div className="form-group">
              ...
              {selectedTimetable && (
                <small style={{ color: '#999' }}>Program cannot be changed</small>
              )}
            </div>
          ...
          <div className="modal-actions">
            <button className="cancel-button" onClick={() => setShowTimetableModal(false)}>
              Cancel
            </button>
            <button className="confirm-button" onClick={handleSaveTimetable}>
              {selectedTimetable ? "Update" : "Create"} Timetable
            </button>
          </div>
        </div>
      </div>
